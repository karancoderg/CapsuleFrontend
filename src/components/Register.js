        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="password-container">
            <input
              ...
              required
            />
            {confirmPassword && !passwordMatch && <div className="password-mismatch">Passwords do not match</div>}
          </div>
          <button type="submit" disabled={isSubmitting || !passwordMatch} className={isSubmitting ? "submitting" : ""}>
